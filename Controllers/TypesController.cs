...
namespace Jewerly.Controllers
{
    public class TypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TypeName,RegisterOn")] Type @type)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TypeName,RegisterOn")] Type @type)
        {
            if (id != @type.Id)
            {
                return NotFound();
